...
```{r improc-unaltered, message=FALSE}
im <- imList[[1]]
par(mfrow=c(1,2))
...
```{r improc-winsored, message=FALSE}
...
```{r improc-autobright, message=FALSE}
...
```{r improc-log, message=FALSE}
norm <- imLaplacianOfGaussian(im, smallBlur = 1, bigBlur = 5 )
par(mfrow=c(1,2))
plot( imager::as.cimg(norm), main = 'Laplacian of Gaussians' )
plot( imager::as.cimg(norm[1000:1500, 1000:1500, 1]), main = 'Laplacian of Gaussians (Zoom in)' )
par(mfrow=c(1,1))
```
...
```{r improc-logandnorm, message=FALSE}
norm <- imLaplacianOfGaussian(im, smallBlur = 1, bigBlur = 5 )
norm <- imNormalise(norm, 0, max(norm))
par(mfrow=c(1,2))
plot( imager::as.cimg(norm), main = 'Laplacian of Gaussians >0' )
plot( imager::as.cimg(norm[1000:1500, 1000:1500, 1]), main = 'Laplacian of Gaussians >0 (Zoom in)' )
par(mfrow=c(1,1))
```
...
```{r improc-hessdet, message=FALSE}
...
```{r improc-hessdetmask, message=FALSE}
norm <- imHessianDeterminant(im, smallBlur = 1)
...
```{r improc-hessdet-blurvnoblur, message=FALSE}
par(mfrow=c(1,3))
...
plot( imager::as.cimg(imHessianDeterminant(im[1200:1300, 1200:1300, 1], smallBlur = 1)), main = 'detHess (Zoom in): Slight blur' )
par(mfrow=c(1,1))
```
...
```{r improc-lowpass, message=FALSE}
...
```{r improc-defaultmasking, message=FALSE}
...
```{r improc-defaultmaskingreplaced, fig.width=6, fig.height=16, message=FALSE}
...
```{r improc-imagemetrics, message=FALSE}
getImageMetrics( 
  imList,
  imageFunctions = list(
    'ORIG' = imReturn,
...
```{r improc-imagemetrics-zoomed, message=FALSE}
par(mfrow=c(2,3))
